...
function geozone_analysis(latlim, lonlim, years, geozone, wet_months)
    ...
    plot_pca_timeseries(pca_timeseries, years, geozone);
    ...
    label='';
    plot_map(compo1, latlim, lonlim, ['PC1 - ', geozone],label);
    plot_map(compo2, latlim, lonlim, ['PC2 - ', geozone],label);
    plot_map(compo3, latlim, lonlim, ['PC3 - ', geozone],label);
end
...
function plot_pca_timeseries(pca_timeseries, years, geozone)
    fig=figure;
...
%     figure
    ...
    % Add title and axis labels
    titlo = ['Time series of Principal Component 1, 2 & 3 - ' geozone];
    title(titlo)
    xlabel('Month')
